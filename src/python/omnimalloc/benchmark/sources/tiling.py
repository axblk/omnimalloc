...
class TilingSource(TilingBase):
    ...
    recursive divide-and-conquer (the guillotine sibling of
    :class:`PinwheelSource`). ``mem_cut_prob`` tunes temporal contention (and
    thus hardness) by biasing cuts toward the memory axis. See
